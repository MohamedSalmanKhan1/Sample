...
import com.salman.RestAPIStudentProject.util.RESTAPIerror;
...
public ResponseEntity<?> getStudent(@PathVariable("id") long id) {
	...
	if (student == null) {
		...
		return new ResponseEntity(new RESTAPIerror("Student with id " + id
	...
	public ResponseEntity<?> createStudent(@RequestBody Student student, UriComponentsBuilder ucBuilder) {
		...
		if (studentService.isStudentExist(student)) {																																																																																																																																																																																																																																																																																																																																																																																																																																																									
			...
			return new ResponseEntity(new RESTAPIerror("Unable to create. A Student with name " +																					
	...
	public ResponseEntity<?> deleteStudent(@PathVariable("id") long id) {
		...
		if (student == null) {
			...
			return new ResponseEntity(new RESTAPIerror("Unable to delete. Student with id " + id + " not found."),
					HttpStatus.NOT_FOUND);
		}
